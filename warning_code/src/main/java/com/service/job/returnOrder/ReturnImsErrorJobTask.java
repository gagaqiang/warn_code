 ...
 * @Description:退货单，IMS返回失败 (YJ00011)
 */
@Component
public class ReturnImsErrorJobTask {


    public final static Logger _logger = LoggerFactory.getLogger(ReturnImsErrorJobTask.class);
    ...
    public void getErrorMsg() {
        ...
        try {
            tcErrorMsgService.dealTcErrorMsg(WarningEnum.WARNING_IT_RETURN_IMS_ERROR.getId(), false);
        } catch (Exception e) {
    ...
    public void sendErrorMsg() {
        ...
        try {
            warningSendMsgService.updateWarnAndSendMsg(WarningEnum.WARNING_IT_RETURN_IMS_ERROR.getId());
        } catch (Exception e) {
